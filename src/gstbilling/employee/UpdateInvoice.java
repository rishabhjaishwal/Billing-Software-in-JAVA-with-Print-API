...
import static gstbilling.employee.Invoice.name;
 ...
 * @author Shivam Kumar
 */
public class UpdateInvoice extends javax.swing.JInternalFrame {
    private Object jinvoice;
...
double amount;
    ...
    try{
             ...
             if(rs.next())
             {
                   ...
                   ps=con.prepareStatement("Select invoiceno from invoicecustomer ");
                   ResultSet rs1=ps.executeQuery();
                   while(rs1.next()){
                       String ss=rs1.getString("invoiceno");
                       invoicenumber.addItem(rs1.getString("invoiceno"));
                   }
             }
          discount.setText("0");
    ...
    public ArrayList<User> usersList(){
      ...
      try
        {  
          ...
          ps.setString(1,invoicenumber.getSelectedItem().toString());
          ResultSet rs=ps.executeQuery();
          User user;
          sn=1;
          Totalamt =0.0;
          ...
          { 
             ...
             Ttalamt.setText(new DecimalFormat("##.##").format(Totalamt));
...
public void show_user(){
  ...
  //  DefaultTableModel model= (DefaultTableModel)showTable.getModel();
    ...
    private void initComponents() {
        ...
        invoicenumber = new javax.swing.JComboBox();
        ...
        invoicenumber.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 14)); // NOI18N
        invoicenumber.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Invoice No" }));
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(jCombostate, 0, 174, Short.MAX_VALUE)
                                .addComponent(invoicenumber, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addGap(79, 79, 79))))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(24, 24, 24)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(35, 35, 35)
                .addComponent(snumber, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
                .addGap(66, 66, 66)
    ...
    private void jsavebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jsavebuttonActionPerformed
        try{
            Connection con=Connect.connect();
            PreparedStatement ps=con.prepareStatement("update invoicecustomer set customername=?,emailid=?,aadharno=?,phoneno=?,invoicedeclaredby=? where invoiceno=?");
            ps.setString(1,jcustname.getText());
            ps.setString(2,jemail.getText());
            ps.setString(3,jaadharno.getText());
            ps.setString(4,jphoneno.getText());
            ps.setString(5,jemployeedeclare.getText());
            ps.setString(6,invoicenumber.getSelectedItem().toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            ps1.setString(2, invoicenumber.getSelectedItem().toString());
            ResultSet rs1= ps1.executeQuery();
            while(rs1.next()){
                no=no+1;
            }
            if(no<1){
                ...
                ps.setString(10,invoicenumber.getSelectedItem().toString());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try{
            ...
            ps.setString(8,invoicenumber.getSelectedItem().toString());
  ...
  {    
      ...
      int result = NO_SUCH_PAGE;    
        ...
        try{
            ...
            g2d.drawString(" Invoice No:- "+invoicenumber.getSelectedItem().toString(),12, y);
...
protected static double toPPI(double inch) {            
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
            try {
                ...
                pj.setPrintable(new UpdateInvoice.BillPrintable(),getPageFormat(pj));
                pj.print();
    ...
    private void invoicenumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_invoicenumberActionPerformed
         try{
                show_user();
            Connection con=Connect.connect();
            PreparedStatement ps=con.prepareStatement("select * from invoicecustomer where invoiceno=?");
            ps.setString(1,invoicenumber.getSelectedItem().toString());
            ResultSet rs=ps.executeQuery();
            if(rs.next())
            {
                 jcustname.setText(rs.getString("customername"));
                 jphoneno.setText(rs.getString("phoneno"));
                 jemployeedeclare.setText(rs.getString("invoicedeclaredby"));
                 jaadharno.setText(rs.getString("aadharno"));
                 jcustemail.setText(rs.getString("emailid"));
            }
         }
         catch(Exception ex){
             JOptionPane.showMessageDialog(this, ex);
    ...
    private javax.swing.JComboBox invoicenumber;
